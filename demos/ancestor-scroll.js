...
const targetContainerMessage = 'InfiniteScroll set to use an ancestor element for scrolling.';
const colors = ['#9bc95b', '#ffd47b', '#95a9d6', '#ffa8e1'];

export default class AncestorScroll extends React.Component {
  constructor () {
    super();
    this.state = {
      divs: divs
