...
| **outerDivClassName**          | string               | add any custom class you want for the outer (wrapper) div                                                                                                                                                                                                                                                                                     |
| **outerDivStyle**              | object               | any style which you want to override on the outer (wrapper) div                                                                                                                                                                                                                                                                               |
